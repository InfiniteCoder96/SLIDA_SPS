                        ...
                        <div class="table-responsive">
                                        ...
                                        @foreach ($temporary_students as $temporary_student)
                                            <tr>
                                                ...
                                                <td style="font-size: 12px">
                                                    ...
                                                    <a  class="waves-effect waves-dark" href="{{action('TemporaryStudentController@edit', $temporary_student['id'])}}"><button class="btn btn-info btn-xs" type="button">UPDATE</button></a>
                                                </td>
                            ...
                            @else
                                    <div class="card bg-dark text-white" style="margin-top: 20px">
                                        <div class="card-body">
                                            <center><h2 class="card-title blinking">No new selected Students</h2></center>
