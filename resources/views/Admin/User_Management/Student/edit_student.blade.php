        ...
        <div class="container-fluid">
            ...
            <div class="card text-left">
                <div class="card-header bg-dark text-orange " style="font-size: 20px">
                    Student ID : <span class="blinking">{{$student->sid}}</span>
                </div>
                ...
                <div class="card-header bg-secondary text-success ">
                    <input class="btn btn-danger btn-lg" type="button" id="editable_btn" value="Make Editable" onclick="change_name()">
                </div>
                <div class="card-body bg-secondary">
                    ...
                    <form enctype="multipart/form-data" class="needs-validation" novalidate action="{{action('TemporaryStudentController@updateSelectedStudents')}}" method="post" id="formfield">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="{{asset('assets/images/no-image.png')}}" id="img" style="height:280px;width: 280px;background-color: #ccc;border: 3px solid white;">
                                <div class="form-row">
                                    <div class="col-md-11 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="button" value="Browse" id="browse_image" class="btn btn-dark form-control">
                        ...
                        <div class="card-title text-orange text-center bg-dark">
                            <i class="mdi mdi-account-card-details"></i> Payment Details
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-dark text-light" id="inputGroupPrepend">Application Fee</span>
                                    </div>
                                    <select name="application_fee" class="form-control" >
                                        <option selected disabled>- Select Payment Status -</option>
                                        <option value="Msc">Not Paid</option>
                                        <option value="Degree">Paid</option>
                                    </select>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-dark text-light" id="inputGroupPrepend">Admission Fee</span>
                                    </div>
                                    <select name="addmission_fee" class="form-control" >
                                        <option selected disabled>- Select Payment Status -</option>
                                        <option value="Msc">Not Paid</option>
                                        <option value="Degree">Paid</option>
                                    </select>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-dark text-light" id="inputGroupPrepend">Course Fee</span>
                                    </div>
                                    <input type="text" name="course_fee" class="form-control" value="{{$student['course_fee']}}" placeholder="Enter Course Fee" aria-describedby="inputGroupPrepend" >
                        ...
                        <div class="card-footer text-white bg-dark">
                            ...
                            <input name="ref_num" type="hidden" value="{{$student->ref_num}}">
                            <input type="hidden" name="class_type" class="form-control" value="{{$student['class_type']}}" placeholder="Username" aria-describedby="inputGroupPrepend" >
                            <input type="hidden" name="sponsored" class="form-control" value="{{$student['sponsored']}}" placeholder="Username" aria-describedby="inputGroupPrepend" >

                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#acceptConfirmationModal">SUBMIT</button>
            ...
            <script>
                ...
                $(document).ready(function(){
                    ...
                    var fieldHTML = '<div class="field_wrapper_01">\n' +
                        '                            <div class="form-row">\n' +
                        '\n' +
                        '                                    <div class="col-md-5 mb-3">\n' +
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Organization Name</span>\n' +
                        '                                            </div>\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Organization Address</span>\n' +
                        '                                            </div>\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Employment Period</span>\n' +
                        '                                            </div>\n' +
                ...
                $(document).ready(function(){
                    ...
                    var fieldHTML = '<div class="field_wrapper_02">\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Qualification Type</span>\n' +
                        '                                            </div>\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Qualification Name</span>\n' +
                        '                                            </div>\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Institute Name</span>\n' +
                        '                                            </div>\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Specialized Area</span>\n' +
                        '                                            </div>\n' +
                        ...
                        '                                        <div class="input-group">\n' +
                        '                                            <div class="input-group-prepend">\n' +
                        '                                                <span class="input-group-text" id="inputGroupPrepend">Grade/Class</span>\n' +
                        '                                            </div>\n' +
