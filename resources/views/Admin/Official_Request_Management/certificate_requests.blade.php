...
@section('content')
    ...
    <div class="page-wrapper" style="background-image: url('/public/assets/images/big/img0.jpg')">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    @if(count($certificate_requests) > 0)
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">Result Information<span class="label label-info" style="font-size: 20px">{{count($certificate_requests)}}</span></h5>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($certificate_requests as $certificate_request)
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 12px">{{$certificate_request->sid}}</td>
                                            <td style="font-size: 12px">{{$certificate_request->data['full_name']}}</td>
                                            <td style="font-size: 12px">{{$certificate_request->data['NIC']}}</td>
                                            <td style="font-size: 12px">{{$certificate_request->data['email']}}</td>
                                            <td style="font-size: 12px">{{$certificate_request->data['reason']}}</td>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <form action="{{url('/admin/officialRequests/showPostponementLetter')}}" method="post" >
                                                            {{csrf_field()}}
                                                            <input name="id" type="hidden" value="{{$certificate_request->id}}">
