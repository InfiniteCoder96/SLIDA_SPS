        ...
        <div class="col-md-12">
            ...
            <div class="card bg-dark">
                <div class="card-header">
                    <b><h5 style="color: whitesmoke">CERTIFICATE REQUEST FORM</h5></b>
                </div>

                <form class="needs-validation" action="{{url('submitForm')}}" method="post">
                    {{csrf_field()}}
                    <input name="request" value="certificate-request-form" type="hidden">
                <div class="card-body">
                    <div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-dark text-light" id="inputGroupPrepend" >Reason for requesting certificates</span>
                                </div>
