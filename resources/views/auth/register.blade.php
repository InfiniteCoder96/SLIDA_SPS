                    ...
                    <div class="row p-b-30">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Full Name" aria-label="Name" aria-describedby="basic-addon1" name="username" value="{{old('Username')}}">
                            </div>
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control form-control-lg" placeholder=" Confirm Password" aria-label="Password" aria-describedby="basic-addon1" name="password_confirmation">
                            </div>
                        </div>
                    </div>
                    <div class="row border-top border-secondary">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="p-t-20">
                                    <a href="{{url('/')}}"><button class="btn btn-block btn-lg btn-outline-purple" type="button">Go Back</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
