        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="{{asset('assets\images\logos\SLIDA_logo-_2018.png')}}" style="width: 90px;height: 90px"><br><Text style="color: whitesmoke;font-size: 20px;font-family: 'Nova Mono', monospace;">SPS Management System</Text></span>
                </div>
                @if(count($errors) > 0)
